...
var SaveStep2Dto = /** @class */ (function () {
    function SaveStep2Dto() {
    }
    __decorate([
    ...
    __decorate([
        (0, swagger_1.ApiPropertyOptional)({ description: 'Neck circumference in cm', example: 38 }),
        (0, class_validator_1.IsNumber)(),
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.Min)(0),
        __metadata("design:type", Number)
    ], SaveStep2Dto.prototype, "neckCircumference", void 0);
    return SaveStep2Dto;
}());
