...
exports.EpworthScore = void 0;
var typeorm_1 = require("typeorm");
var questionnaire_entity_1 = require("./questionnaire.entity");
var EpworthScore = /** @class */ (function () {
    function EpworthScore() {
    }
    __decorate([
        (0, typeorm_1.PrimaryGeneratedColumn)('uuid'),
        __metadata("design:type", String)
    ], EpworthScore.prototype, "id", void 0);
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.OneToOne)(function () { return questionnaire_entity_1.Questionnaire; }, function (q) { return q.epworth_score; }, { onDelete: 'CASCADE' }),
        (0, typeorm_1.JoinColumn)({ name: 'questionnaire_id' }),
        __metadata("design:type", questionnaire_entity_1.Questionnaire)
    ], EpworthScore.prototype, "questionnaire", void 0);
    EpworthScore = __decorate([
        (0, typeorm_1.Entity)('epworth_scores')
    ], EpworthScore);
    return EpworthScore;
}());
exports.EpworthScore = EpworthScore;
