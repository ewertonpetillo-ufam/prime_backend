...
exports.FogqScore = void 0;
var typeorm_1 = require("typeorm");
var questionnaire_entity_1 = require("./questionnaire.entity");
var FogqScore = /** @class */ (function () {
    function FogqScore() {
    }
    __decorate([
        (0, typeorm_1.PrimaryGeneratedColumn)('uuid'),
        __metadata("design:type", String)
    ], FogqScore.prototype, "id", void 0);
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.OneToOne)(function () { return questionnaire_entity_1.Questionnaire; }, function (q) { return q.fogq_score; }, { onDelete: 'CASCADE' }),
        (0, typeorm_1.JoinColumn)({ name: 'questionnaire_id' }),
        __metadata("design:type", questionnaire_entity_1.Questionnaire)
    ], FogqScore.prototype, "questionnaire", void 0);
    FogqScore = __decorate([
        (0, typeorm_1.Entity)('fogq_scores')
    ], FogqScore);
    return FogqScore;
}());
exports.FogqScore = FogqScore;
