...
var UdysrsScore = /** @class */ (function () {
    function UdysrsScore() {
    }
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.OneToOne)(function () { return questionnaire_entity_1.Questionnaire; }, function (q) { return q.udysrs_score; }, { onDelete: 'CASCADE' }),
