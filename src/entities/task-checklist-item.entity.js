...
var TaskChecklistItem = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return active_task_definition_entity_1.ActiveTaskDefinition; }, function (task) { return task.checklist_items; }, {
            onDelete: 'CASCADE',
        }),
