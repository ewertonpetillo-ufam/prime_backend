...
var StopbangScore = /** @class */ (function () {
    function StopbangScore() {
    }
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.OneToOne)(function () { return questionnaire_entity_1.Questionnaire; }, function (q) { return q.stopbang_score; }, { onDelete: 'CASCADE' }),
    ...
    StopbangScore = __decorate([
        (0, typeorm_1.Entity)('stopbang_scores')
    ], StopbangScore);
    return StopbangScore;
}());
