...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email or registration number already registered' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all users (optionally filtered by role)' }),
