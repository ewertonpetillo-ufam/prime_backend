...
__decorate([
    (0, typeorm_1.OneToOne)(() => questionnaire_entity_1.Questionnaire, (q) => q.nms_score, { onDelete: 'CASCADE' }),
...
exports.NmsScore = NmsScore = __decorate([
    (0, typeorm_1.Entity)('nms_scores')
], NmsScore);
//# sourceMappingURL=nms-score.entity.js.map